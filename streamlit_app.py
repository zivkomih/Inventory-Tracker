...
barplot = sns.barplot(x='Percentage', y='Category', data=df_values_beliefs, palette=colors)
...
for index, value in enumerate(df_values_beliefs['Percentage']):
...
plt.figure(figsize=(12, 7))
barplot = sns.barplot(x='Percentage', y='Category', data=df_luxury_purchase_expanded, palette=colors)
...
# Prozentzahlen hinzufügen
for index, value in enumerate(df_luxury_purchase_expanded['Percentage']):
    barplot.text(value + 1, index, f'{value}%', color='black', va="center")
...
barplot = sns.barplot(x='Percentage', y='Category', hue='Type', data=df_combined, palette=colors[:2])
...
# Prozentzahlen hinzufügen
for index, value in enumerate(df_combined['Percentage']):
    barplot.text(value + 1, index, f'{value}%', color='black', va="center")
...
plt.figure(figsize=(12, 7))
barplot = sns.barplot(x='Percentage', y='Category', data=df_porsche_spirituality, palette=colors)
...
# Prozentzahlen hinzufügen
for index, value in enumerate(df_porsche_spirituality['Percentage']):
    barplot.text(value + 1, index, f'{value}%', color='black', va="center")
